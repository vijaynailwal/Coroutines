...
import kotlinx.android.synthetic.main.activity_cancel_and_reset_job3.*
...
class CancelAndResetJob3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cancel_and_reset_job3)

        job_button.setOnClickListener {
            //check the job is initialized or not
